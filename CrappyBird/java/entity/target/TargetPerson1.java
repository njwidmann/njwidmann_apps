...
public class TargetPerson1 extends Target {
    ...
    public void setSlowMotionActivated(boolean bool) {
        super.setSlowMotionActivated(bool);
        if(bool) {
    ...
    public void hitsGround(boolean gameOver) {
        setFalling(false);
        hitWithCrap(gameOver); //changes to gravestone and sets velocity to scroll or 0 (if gameover = true)
    }
